 ...
 * Description:
 */
public class HomeJapanBinder extends ItemViewBinder<JapanHomeItem, HomeJapanBinder.Holder> {

    @NonNull
    @Override
    protected Holder onCreateViewHolder(@NonNull LayoutInflater inflater, @NonNull ViewGroup parent) {
        View inflate = inflater.inflate(R.layout.item_homepage_japan, parent, false);
        return new Holder(inflate);
    }

    @Override
    protected void onBindViewHolder(@NonNull Holder holder, @NonNull JapanHomeItem item) {
