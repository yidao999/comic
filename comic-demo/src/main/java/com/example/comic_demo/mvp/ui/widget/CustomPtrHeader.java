...
public class CustomPtrHeader extends FrameLayout implements PtrUIHandler {
    ...
    public CustomPtrHeader(Context context) {
        ...
        mLastUpdateTimeKey = "CustomPtrHeader_last_update_mode";
        init(context);
    }
    ...
    private void init(Context context) {
        View view = LayoutInflater.from(context).inflate(
                R.layout.public_text_refresh_header, this);
        mShouldShowLastUpdate = true;
        refreshImage = (ImageView) view.findViewById(R.id.refresh_loading);//动画icon
        mLastUpdateTextView = (TextView) view.findViewById(R.id.latest_fresh_time);//时间text
        initAnimation();//设置icon动画
        tryUpdateLastUpdateTime();
    }

    private void initAnimation() {
        refreshImage.setImageResource(R.drawable.loading_top);
        AnimationDrawable drawable = (AnimationDrawable) refreshImage.getDrawable();
        drawable.start();
    }
