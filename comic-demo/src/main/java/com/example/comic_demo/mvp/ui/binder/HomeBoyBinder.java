 ...
 * Description:
 */
public class HomeBoyBinder extends ItemViewBinder<BoyHomeItem, HomeBoyBinder.Holder> {
    ...
    @Override
    protected void onBindViewHolder(@NonNull Holder holder, @NonNull BoyHomeItem item) {
