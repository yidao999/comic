 ...
 * Description:
 */
public class HomeComicBinder extends ItemViewBinder<ComicHomeItem, HomeComicBinder.Holder> {
    ...
    @Override
    protected void onBindViewHolder(@NonNull Holder holder, @NonNull ComicHomeItem item) {
